        ...
        <AdminContentBlock title={'New User'}>
            <div css={tw`w-full flex flex-row items-center mb-8`}>
                <div css={tw`flex flex-col flex-shrink`} style={{ minWidth: '0' }}>
                    <h2 css={tw`text-2xl text-neutral-50 font-header font-medium`}>Новый Пользователь</h2>
                    <p css={tw`text-base text-neutral-400 whitespace-nowrap overflow-ellipsis overflow-hidden`}>
                        Добавьте нового пользователя в панель.
                    </p>
                </div>
            </div>
            ...
            <UserForm title={'Создать Пользователя'} onSubmit={submit} role={null} />
        </AdminContentBlock>
    );
};
